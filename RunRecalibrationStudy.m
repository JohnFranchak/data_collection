...
[mu_est_aff, sigma_est_aff, trial_unit_aff, trial_resp_aff, time_aff] = DataCollection(out_dir, id{1}, 'aff', stim_levels_aff, 4, 32 , 20);
save(strcat(out_dir,'/',id{1}));
[mu_est_pst, sigma_est_pst, trial_unit_pst, trial_resp_pst, time_pst] = DataCollection(out_dir, id{1}, 'pst', stim_levels_dec, 0, 30, 30);
save(strcat(out_dir,'/',id{1}));
[mu_est_npk, sigma_est_npk, trial_unit_npk, trial_resp_npk, time_npk] = DataCollection(out_dir, id{1}, 'npk', stim_levels_dec, 4, mu_est_aff - 10, 15);
