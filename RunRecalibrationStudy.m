...
[mu_est_aff, sigma_est_aff, trial_unit_aff, trial_resp_aff, time_aff] = DataCollection(out_dir, id{1}, strcat('aff_',cond{1}), stim_levels_aff, 4, 30, 20);
save(strcat(out_dir,'/',id{1}));
...
save(strcat(out_dir,'/',id{1}));
[mu_est_npk, sigma_est_npk, trial_unit_npk, trial_resp_npk, time_npk] = DataCollection(out_dir, id{1}, strcat('npk_',cond{1}), stim_levels_dec, 4, mu_est_aff - 5, 10);
save(strcat(out_dir,'/',id{1}));
